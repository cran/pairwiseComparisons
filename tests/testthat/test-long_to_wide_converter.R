...
testthat::test_that(
  ...
  code = {
    ...
    # within-subjects
    set.seed(123)
    df1 <- pairwiseComparisons:::long_to_wide_converter(
      data = iris_long,
      x = condition,
      y = value
    )
    ...
    # between-subjects
    set.seed(123)
    df2 <- pairwiseComparisons:::long_to_wide_converter(
      data = mtcars,
      x = am,
      y = wt,
      paired = FALSE
    ...
    # within-subjects
    set.seed(123)
    df3 <- pairwiseComparisons:::long_to_wide_converter(
      data = data_bugs,
      x = condition,
      y = desire
    )
    ...
    # between-subjects
    set.seed(123)
    df4 <- pairwiseComparisons:::long_to_wide_converter(
      data = ggplot2::msleep,
      x = vore,
      y = brainwt,
      paired = FALSE
