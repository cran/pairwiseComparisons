...
#> 1 carni  insecti          -0.058 0.027   1.53   10.7       1 ns           list(~italic(p)[ adjusted ]== 1.000 ) Games-Howell test
#> 2 herbi  carni            -0.542 0.25    1.54   19.4       1 ns           list(~italic(p)[ adjusted ]== 1.000 ) Games-Howell test
#> 3 herbi  insecti          -0.6   0.249   1.70   19.1       1 ns           list(~italic(p)[ adjusted ]== 1.000 ) Games-Howell test
#> 4 omni   carni            -0.066 0.061   0.774  21.1       1 ns           list(~italic(p)[ adjusted ]== 1.000 ) Games-Howell test
#> 5 omni   herbi             0.476 0.255   1.32   20.9       1 ns           list(~italic(p)[ adjusted ]== 1.000 ) Games-Howell test
#> 6 omni   insecti          -0.124 0.057   1.55   17.2       1 ns           list(~italic(p)[ adjusted ]== 1.000 ) Games-Howell test
#>   p.value.adjustment
#>   <chr>             
#> 1 Bonferroni        
#> 2 Bonferroni        
...
#> # A tibble: 6 x 8
#>   group1  group2  z.value p.value significance label                                   test.details p.value.adjustment
#>   <chr>   <chr>     <dbl>   <dbl> <chr>        <chr>                                   <chr>        <chr>             
#> 1 carni   herbi     0.582  0.561  ns           list(~italic(p)[ unadjusted ]== 0.561 ) Dunn test    None              
#> 2 carni   insecti   1.88   0.0595 ns           list(~italic(p)[ unadjusted ]== 0.060 ) Dunn test    None              
#> 3 carni   omni      1.14   0.254  ns           list(~italic(p)[ unadjusted ]== 0.254 ) Dunn test    None              
#> 4 herbi   insecti   1.63   0.102  ns           list(~italic(p)[ unadjusted ]== 0.102 ) Dunn test    None              
#> 5 herbi   omni      0.717  0.474  ns           list(~italic(p)[ unadjusted ]== 0.474 ) Dunn test    None              
#> 6 insecti omni      1.14   0.254  ns           list(~italic(p)[ unadjusted ]== 0.254 ) Dunn test    None
...
#> 1 carni   herbi   -0.0530   -0.274     0.168    0.969 ns           list(~italic(p)[ adjusted ]== 0.969 ) Yuen's trimmed means test
#> 2 carni   insecti  0.0577   -0.0609    0.176    0.969 ns           list(~italic(p)[ adjusted ]== 0.969 ) Yuen's trimmed means test
#> 3 carni   omni     0.00210  -0.151     0.155    0.969 ns           list(~italic(p)[ adjusted ]== 0.969 ) Yuen's trimmed means test
#> 4 herbi   insecti  0.111    -0.0983    0.320    0.969 ns           list(~italic(p)[ adjusted ]== 0.969 ) Yuen's trimmed means test
#> 5 herbi   omni     0.0551   -0.173     0.283    0.969 ns           list(~italic(p)[ adjusted ]== 0.969 ) Yuen's trimmed means test
#> 6 insecti omni    -0.0556   -0.184     0.0728   0.969 ns           list(~italic(p)[ adjusted ]== 0.969 ) Yuen's trimmed means test
#>   p.value.adjustment  
#>   <chr>               
...
#> # A tibble: 6 x 12
#>   group1 group2   bf10     error  bf01 log_e_bf10 log_e_bf01 log_10_bf10 log_10_bf01 bf.prior label                        test.details    
#>   <chr>  <chr>   <dbl>     <dbl> <dbl>      <dbl>      <dbl>       <dbl>       <dbl>    <dbl> <chr>                        <chr>           
#> 1 omni   herbi   0.571 0.0000411  1.75     -0.560      0.560      -0.243       0.243    0.707 list(~log[e](BF[10])==-0.56) Student's t-test
#> 2 omni   carni   0.427 0.000105   2.34     -0.851      0.851      -0.369       0.369    0.707 list(~log[e](BF[10])==-0.85) Student's t-test
#> 3 omni   insecti 0.545 0.0000190  1.83     -0.606      0.606      -0.263       0.263    0.707 list(~log[e](BF[10])==-0.61) Student's t-test
#> 4 herbi  carni   0.540 0.0000100  1.85     -0.617      0.617      -0.268       0.268    0.707 list(~log[e](BF[10])==-0.62) Student's t-test
#> 5 herbi  insecti 0.540 0.0000175  1.85     -0.616      0.616      -0.267       0.267    0.707 list(~log[e](BF[10])==-0.62) Student's t-test
#> 6 carni  insecti 0.718 0.000152   1.39     -0.332      0.332      -0.144       0.144    0.707 list(~log[e](BF[10])==-0.33) Student's t-test
```
...
#> # A tibble: 6 x 8
#>   group1 group2     W  p.value significance label                                 test.details        p.value.adjustment   
#>   <chr>  <chr>  <dbl>    <dbl> <chr>        <chr>                                 <chr>               <chr>                
...
#>   group1 group2 psihat conf.low conf.high  p.value significance label                                 test.details             
#>   <chr>  <chr>   <dbl>    <dbl>     <dbl>    <dbl> <chr>        <chr>                                 <chr>                    
#> 1 HDHF   HDLF    1.16    0.318      2.00  1.49e- 3 **           list(~italic(p)[ adjusted ]== 0.001 ) Yuen's trimmed means test
#> 2 HDHF   LDHF    0.5    -0.188      1.19  6.20e- 2 ns           list(~italic(p)[ adjusted ]== 0.062 ) Yuen's trimmed means test
#> 3 HDHF   LDLF    2.10    1.37       2.82  1.79e-10 ***          list(~italic(p)[ adjusted ]<= 0.001 ) Yuen's trimmed means test
#> 4 HDLF   LDHF   -0.701  -1.71       0.303 6.20e- 2 ns           list(~italic(p)[ adjusted ]== 0.062 ) Yuen's trimmed means test
#> 5 HDLF   LDLF    0.938   0.0694     1.81  1.36e- 2 *            list(~italic(p)[ adjusted ]== 0.014 ) Yuen's trimmed means test
#> 6 LDHF   LDLF    1.54    0.810      2.27  1.16e- 6 ***          list(~italic(p)[ adjusted ]<= 0.001 ) Yuen's trimmed means test
#>   p.value.adjustment
#>   <chr>             
#> 1 Hommel            
#> 2 Hommel            
...
#> # A tibble: 3 x 12
#>   group1 group2   bf10       error   bf01 log_e_bf10 log_e_bf01 log_10_bf10 log_10_bf01 bf.prior label                       
#>   <chr>  <chr>   <dbl>       <dbl>  <dbl>      <dbl>      <dbl>       <dbl>       <dbl>    <dbl> <chr>                       
#> 1 Wine A Wine B  0.219 0.000366    4.57        -1.52       1.52      -0.660       0.660     0.77 list(~log[e](BF[10])==-1.52)
#> 2 Wine A Wine C  3.60  0.00000709  0.277        1.28      -1.28       0.557      -0.557     0.77 list(~log[e](BF[10])==1.28) 
#> 3 Wine B Wine C 50.5   0.000000840 0.0198       3.92      -3.92       1.70       -1.70      0.77 list(~log[e](BF[10])==3.92) 
#>   test.details    
#>   <chr>           
#> 1 Student's t-test
#> 2 Student's t-test
...
#>   group1 group2   bf10       error   bf01 log_e_bf10 log_e_bf01 log_10_bf10 log_10_bf01 bf.prior label                       
#>   <chr>  <chr>   <dbl>       <dbl>  <dbl>      <dbl>      <dbl>       <dbl>       <dbl>    <dbl> <chr>                       
#> 1 Wine A Wine B  0.235 0.000313    4.25        -1.45       1.45      -0.628       0.628    0.707 list(~log[e](BF[10])==-1.45)
#> 2 Wine A Wine C  3.71  0.0000120   0.269        1.31      -1.31       0.570      -0.570    0.707 list(~log[e](BF[10])==1.31) 
#> 3 Wine B Wine C 50.5   0.000000769 0.0198       3.92      -3.92       1.70       -1.70     0.707 list(~log[e](BF[10])==3.92) 
#>   test.details     groups   
#>   <chr>            <list>   
